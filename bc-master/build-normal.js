...
//			return;
		...
		if(safe && module < 1){
			if(playerPower(me) > 100 && (policy['build'] == 'standart' || (policy['build'] == 'cyborgs' && cyborg_factory_ready.length > 3) || policy['build'] == 'rich')){
				...
				if(getResearch("R-Struc-Factory-Module").done && ( getResearch("R-Vehicle-Metals02").done || playerPower(me) > 1000 )) { factory.forEach( function(e){ if(e.modules < 2){ orderDroidBuild_p(obj, DORDER_BUILD, "A0FacMod1", e.x, e.y);module++;}});}
			}
