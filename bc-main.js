...
v0.03
? Сделать разветку на нефте-точках
? Написать функцию, возвращающую кол-во строений пушек-обороны на указонной позиции

v0.02 (29.01.2013)
- Написал функцию динамической сборки машин
- Немного зарандомил стартовую позицию базы
- Изменил приоритет атаки (плохо работает, переписывать нужно)

v0.01 (28.01.2013)
- Тестовая версия
- Бот развивается и убивает других ботов
*/
